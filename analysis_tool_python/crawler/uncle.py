...
class UncleCrawler:
    ...
    def load_detail_page(url):
        ...
        while True:
            try:
                ...
                return extract_detail_page(table)
            except Exception as e:
                print(f"{e}\nreloading {url}")
    ...
    def test(self):
        test_info = self.load_detail_page(
            'https://etherscan.io/uncle/0x997b66eb0a1ac77433b07745a0e353708407c7fdc77e93b4cafc0d64f108c040')
